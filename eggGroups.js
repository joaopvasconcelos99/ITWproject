define(['durandal/app'], function (app) {
    var vm = function () {
        ...
        //---Variáveis locais
        var self = this;
        var baseUri = 'http://192.168.160.58/pokemons/api/EggGroups/GetPage';
        self.displayName = 'Pokemón EggGroups List';
